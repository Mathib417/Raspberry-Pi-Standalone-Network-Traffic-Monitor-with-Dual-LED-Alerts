...
PI_IP = "192.168.1.100"  # Replace with your Pi's IP (find with 'hostname -I' on Pi)
PI_USERNAME = "pi"       # Default Pi username, change if different
PI_PASSWORD = "raspberry"  # Default Pi password, change if different
